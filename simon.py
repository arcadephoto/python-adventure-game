            ...
            if difficulty == 5:
                ...
                for number in range(len(list_of_numbers)):
                    ...
                    if int(prompt) == list_of_numbers[number]:
                        ...
                        print("Dr. Longnameovich: Why, you got one wrong. Looks like you'll be useless to me. Say goodbye forever!")
                        exit()
